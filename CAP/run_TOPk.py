...
def parser_args():
    ...
    args.output = os.path.join(args.output, args.dataset_name, '%s'%args.img_size, '%s'%args.lb_ratio,  'TOPk_%s_%s_%s_%s_%s_%s_%s'%(args.loss_lb, args.loss_ub, args.warmup_epochs, args.cutout, args.lr, args.lb_bs, args.epochs))
